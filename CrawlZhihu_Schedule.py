...
if __name__ == "__main__" :
    # 1.定义调度
    schedule.every().day.at("08:00:00").do(CrawlZhihuHostList)
    schedule.every().day.at("14:00:00").do(CrawlZhihuHostList)
    schedule.every().day.at("20:00:00").do(CrawlZhihuHostList)
    # 2.执行任务
    while True:
