...
if __name__ == "__main__" :
    # 1.定义调度
    schedule.every().day.at("06:00:00").do(CrawlZhihuHostList)
    schedule.every().day.at("12:00:00").do(CrawlZhihuHostList)
    schedule.every().day.at("18:00:00").do(CrawlZhihuHostList)
    schedule.every().day.at("24:00:00").do(CrawlZhihuHostList)
    # 2.执行任务
    while True:
